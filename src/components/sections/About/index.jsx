...
const About = () => {
    ...
    return (
        ...
        >
            ...
            >
                <Image
                    src={aboutData ? aboutData.landing_page.about_image : ''}
                    alt="about image"
                ...
                <div className="w-full py-28 max-lg:mx-auto max-lg:w-11/12 max-lg:max-w-7xl lg:ps-10 xl:ps-20">
                    ...
                    <TypingHeading
                        visible="client"
                        headings={aboutData ? aboutData.landing_page.about_title : []}
                    />
                    <Paragraph>
                        {aboutData ? aboutData.landing_page.about_description : ""}
                    </Paragraph>
                </div>
            </div>
        </section >
