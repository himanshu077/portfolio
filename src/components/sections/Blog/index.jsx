        ...
        >
            <Container>
                <div className="mx-auto max-w-5xl">
                    <div
                        className="relative sm:ms-[calc(2rem+1px)] md:ms-[calc(3.5rem+1px)] lg:ms-[max(calc(14.5rem+1px),calc(100%-48rem))]"
                    >
                    ...
                    >
                        <div
                            className="absolute bottom-0 end-full top-3 me-7 hidden w-[0.5px] bg-neutrals-700 sm:block md:me-[3.25rem]"
                        >
                        </div>
